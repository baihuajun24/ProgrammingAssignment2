## There are two functions to solve the inverse of the matrix using cache.
## The first one(makeCacheMatrix) creates the cache space
## The second one(cacheSolve) outputs the result
